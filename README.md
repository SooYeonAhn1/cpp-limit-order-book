...
A high-performance Limit Order Book (LOB) implementation in C++, designed to simulate low-latency matching engines used in High-Frequency Trading (HFT). When running the program, you will see statistics of trade history generated by using virutal data.
